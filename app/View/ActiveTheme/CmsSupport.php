<div class="content-wrapper ng-cloak" ng-app="supportApp" ng-controller="supportController as mainCtrl" ng-init="init()">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h1>{{settings.title || 'Recent support posts'}}</h1>
            </div>
